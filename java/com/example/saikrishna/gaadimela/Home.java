...
import com.example.saikrishna.gaadimela.Service.ListenOrder;
import com.example.saikrishna.gaadimela.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        //because categoryid is key,so we just nee to get this key
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_store) {
            ...
            //Deletes remember password when logged out
            Paper.book().destroy();
